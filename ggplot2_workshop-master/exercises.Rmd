...
ggplot(data = faithful, 
       mapping = aes(x = eruptions, y = waiting, colour = eruptions < 3)) + 
  geom_point()
```
...
```{r}
ggplot(faithful) + 
  geom_point(aes(x = eruptions, y = waiting), alpha = 0.3, shape = 'square')
```
...
```{r}
ggplot(faithful) + 
  geom_histogram(aes(x = eruptions, fill = eruptions < 3.1), colour = 'black')
```
...
```{r}
ggplot(faithful) + 
  geom_histogram(aes(x = eruptions, fill = waiting < 60), colour = 'black', position = 'stack')

ggplot(faithful) + 
  geom_histogram(aes(x = eruptions, fill = waiting < 60), colour = 'black', position = 'identity', alpha = 0.7)

ggplot(faithful) + 
  geom_histogram(aes(x = eruptions, fill = waiting < 60), colour = 'black', position = 'dodge')
```
...
ggplot(faithful) + 
  geom_point(aes(x = eruptions, y = waiting)) +
  geom_abline(slope = -40, intercept = 200, colour = 'blue')
```
...
```{r}
ggplot(mpg) + 
  geom_bar(aes(x = class, y = after_stat(100 * count / sum(count)), fill = class))
```
...
ggplot(mpg) + 
  stat_count(aes(x = class, fill = class))

ggplot(mpg) + 
  stat_count(aes(x = class, colour = class), geom = 'point')
```
...
ggplot(mpg) + 
  ...
  stat_summary(aes(x = class, y = hwy), 
               fun = mean, geom = 'point', colour = 'red') +
  stat_summary(aes(x = class, y = hwy), 
               fun = median, geom = 'point', colour = 'orange')
```
...
ggplot(mpg) + 
  geom_point(aes(x = displ, y = hwy, colour = class)) + 
  scale_colour_brewer(name = "Légende", type = 'qual')
```
