...
Le projet de géostatistique que nous avons rendu, Céline, Léonie et moi, en cours de semestre nous avait permis de mettre en place un code R ayant différentes fonctionnalités. Parmi celles-ci, 

\vspace{0.5cm}
## Le package : moyenne glissante sur des grilles de nombres
\vspace{0.5cm}
